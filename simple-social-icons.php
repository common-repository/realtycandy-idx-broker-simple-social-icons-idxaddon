<?php
/*
Plugin Name: IDX Broker Simple Social Icons
Plugin URI: http://realtycandy.com/idx-addons
Description: A simple, CSS and icon font driven social icons widget for Facebook, Twitter, Pinterest, YouTube, Google+ and more. Forked from Nathan Rice's great plugin.
Author: RealtyCandy
...
class Simple_Social_Icons_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$this->profiles = apply_filters( 'simple_social_default_profiles', array(
			'bloglovin' => array(
				'label'   => __( 'Blogger URI', 'simple-social-icons' ),
				'pattern' => '<li class="social-bloglovin"><a href="%s" %s>' . $this->glyphs['blogger'] . '</a></li>',
			),
			'dribbble' => array(
	...
	function enqueue_css() {
		...
		wp_enqueue_style( 'simple-social-icons-font', esc_url( $cssfile ), array('font-awesome'), '1.0.12', 'all' );
	}
